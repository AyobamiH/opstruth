...
- Published `opstruth@0.2.0` after local validation, exact-commit CI, tarball inspection,
  tarball smoke testing, npm registry smoke testing, tag push, and GitHub release creation.
